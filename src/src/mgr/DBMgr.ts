...
export class DBMgr {
    ...
    Init(http: HTTP, sqlite: SQLite) {
        ...
        let createVisittableSQL = "CREATE TABLE IF NOT EXISTS tb_home_visit (LocalId integer primary key autoincrement not null,CaseId int,TaskId int,VisitId int,"
        +"ScheduleDate nvarchar(10),ScheduleDate_Display nvarchar(10),ScheduleTime nvarchar(10),VisitDate nvarchar(10),VisitDate_Display nvarchar(10),VisitStartTime nvarchar(10),"
        +"VisitEndTime nvarchar(10),presentVolunteer nvarchar(100),supportVolunteer nvarchar(100),Location int,LocationRemarks nvarchar(100),VisitStatus int,"
        +"VisitStatusRemarks nvarchar(100),VisitDetailIndoor nvarchar(50),VisitDetailIndoorRemarks nvarchar(100),VisitDetailOutdoor nvarchar(50),"
        +"VisitDetailOutdoorRemarks nvarchar(100),VisitDetailOther nvarchar(500),CategoryTopic1 nvarchar(500),CategoryTopic2 nvarchar(500),CategoryTopic3 nvarchar(500),"
        +"Weight Double,Bmi Double,Waist Double,Hip Double,WHRatio Double,SYS1 Double,DlA1 Double,SYS2 Double,DlA2 Double,heartBeats1 Double,heartBeats2 Double,"
        +"LifeStyleQuestion1 int,LifeStyleQuestion2 int,LifeStyleQuestion3 int,LifeStyleQuestion4 int,LifeStyleQuestion5 int,LifeStyleQuestion6 int,LifeStyleMeasureBloodSuger int,"
        +"LifeStyleMeasureBsLocation int,LifeStyleMeasureBsPeriod int,LifeStyleMeasureBsNoOfTime int,LifeStyleMeasureBloodPressure int,LifeStyleMeasureBpLocation int,"
        ...
        if (this.win.sqlitePlugin) {
            ...
            this.type = 1;
            //alert(2);
            this._db = this.win.openDatabase("appdata55.db", '1.0', 'database', 5 * 1024 * 1024);
            this.execSql(dbcreateUSERsql);
            this.execSql(createActivityTableSQL);
            this.execSql(createPhoneTableSQL);
            this.execSql(createHosiptal);
